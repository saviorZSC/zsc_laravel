@if(Auth::check())
    <!--模态框-->
    <!--创建tasks表单-->
    <div class="modal" id="taskModalfinish" tabindex="-1" role="dialog" aria-labelledby="myModallable" aria-hidden="true">
    ...
    <!--查看tasks内容的模态框-->
    <div class="modal" id="taskModalshowfinish" tabindex="-1" role="dialog" aria-labelledby="myModallable" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
            ...
            <div class="panel-heading panel-info panel-set">
                ...
                <div class="dropdown pull-right">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li class="divider"></li>
                        <li >
                            <a href="#" data-toggle="modal" data-target="#taskModalfinish">
            ...
            <table id="plantask-table" class="table table-striped table-bordered">
                ...
                @foreach($finishTasks as $task)
                    <tr class="_tasks">
                        <td>
                            <a href="#" class="task_a">
                                <span  data-toggle="modal" data-target="#taskModalshowfinish" class="tasksshow"  data-whatever="{{url('/feature/task/'.$task->id)}}" class="pull-left">
                                    {{$task->name}}
                                </span>
                            </a>
                        </td>
